...
def model_opts(parser):
    ...
    group.add_argument('-encoder_type', type=str, default='rnn',
                       choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn', 'trigramrnn'],
                       help="""Type of encoder layer to use. Non-RNN layers
                       are experimental. Options are
                       [rnn|brnn|mean|transformer|cnn|trigramrnn].""")
    group.add_argument('-decoder_type', type=str, default='rnn',
                       choices=['rnn', 'transformer', 'cnn', 'trigramrnn'],
...
def preprocess_opts(parser):
    ...
    group.add_argument('-data_type', default="text",
                       ...
                       Options are [text|img|text-trigram].""")
