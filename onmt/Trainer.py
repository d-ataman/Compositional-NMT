...
class Trainer(object):
    ...
    def validate(self, valid_iter):
        ...
        for batch in valid_iter:
            ...
            elif self.data_type == 'text-trigram':
            ...
            if self.model.model_type == "text-trigram":
                    outputs, attns, dec_state = \
                    self.model(src, tgt, src_lengths, batch_size=batch.batch_size)
            else:
    ...
    def _gradient_accumulation(self, true_batchs, total_stats,
        ...
        for batch in true_batchs:
            ...
            for j in range(0, target_size-1, trunc_size):
                ...
                #If we are using trigrams we need to pass the batch size as an additional parameter
                if self.model.model_type == "text-trigram":
                    outputs, attns, dec_state = \
                    self.model(src, tgt, src_lengths, dec_state, batch_size)
                else:
                    outputs, attns, dec_state = \
