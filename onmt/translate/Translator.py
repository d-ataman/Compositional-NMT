...
class Translator(object):
    ...
    def translate_batch(self, batch, data):
        ...
        src_map = rvar(batch.src_map.data) \
            if data_type in ['text', 'text-trigram'] and self.copy_attn else None
        memory_bank = rvar(memory_bank.data)
        memory_lengths = src_lengths.repeat(beam_size) if data_type == 'text' else src_lengths[1].repeat(beam_size)
